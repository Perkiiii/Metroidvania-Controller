...
namespace WorldGraphEditor.Editor
{
    internal static class SceneScreenshotUtility
    {
        public static long GetScreenshotFileSize(string sceneGuid)
        {
            ...
            var path = GetScreenshotPath(sceneGuid);
        ...
        public static Sprite GetSpriteForScreenshot(string sceneGuid)
        {
            ...
            var texture = WGEAssetPathUtility.LoadAsset<Texture2D>($"Editor/Screenshots/{sceneGuid}.png", false);
        ...
        public static void SaveScreenshot(Texture2D texture, TextureImporterNPOTScale npotScale, string sceneAssetGuid)
        {
            ...
            var folderPath = WGEAssetPathUtility.GetPath("Editor/Screenshots");
            var fullPath = Path.Combine(folderPath, fileName).Replace("\\", "/");
            
            if (!WGEAssetPathUtility.EnsureFolder("Editor/Screenshots"))
                return;
        ...
        private static string GetScreenshotPath(string sceneGuid) =>
            WGEAssetPathUtility.GetPath($"Editor/Screenshots/{sceneGuid}.png");
    }
}
