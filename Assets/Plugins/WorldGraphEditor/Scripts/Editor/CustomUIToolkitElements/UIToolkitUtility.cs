...
namespace WorldGraphEditor.Editor
{
    internal static class UIToolkitUtility
    {
        ...
        public static Texture CORRECT_ICON_WGE => WGEAssetPathUtility.LoadTexture("Scripts/Editor/Icons/success_icon.png");
        public static Texture WARNING_ICON_WGE => WGEAssetPathUtility.LoadTexture("Scripts/Editor/Icons/warning_icon.png");
        public static Texture ERROR_ICON_WGE => WGEAssetPathUtility.LoadTexture("Scripts/Editor/Icons/error_icon.png");
