    ...
    internal class WorldBuilderGraph : EditorWindow
    {
        ...
        private static WorldBuilderGraph GetEditorWindow(string windowName)
        {
            ...
            var iconPath = EditorGUIUtility.isProSkin
                ? "Assets/WorldGraphEditor/Scripts/Editor/Icons/wgb_window_dark_icon.png"
                : "Assets/WorldGraphEditor/Scripts/Editor/Icons/wgb_window_light_icon.png";

            var image = AssetDatabase.LoadAssetAtPath<Texture>(iconPath);
        ...
        private void GenerateToolBar()
        {
            ...
            toolbar.styleSheets.Add(GraphUtility.GetStyleSheet("Assets/WorldGraphEditor/Scripts/Editor/EditorWindows/Styles/Toolbar.uss"));
